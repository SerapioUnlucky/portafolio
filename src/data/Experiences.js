export const experiences = [
    ...
    {
        company: "Universidad del Bío-Bío",
        position: "Encargado de taller PHP Y MySQL",
        period: "Abr. 2023 - Abr. 2023",
        description: "Taller diseñado para proporcionar a los estudiantes universitarios los fundamentos de PHP para el desarrollo web, cubriendo sintaxis, control de flujo y funciones básicas. También incluyó una introducción al uso de bases de datos, como MySQL, con PHP."
    },
    {
