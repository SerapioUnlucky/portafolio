...
export const Projects = () => {
    ...
    return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mx-auto p-4">
            ...
            <a href="https://github.com/SerapioUnlucky?tab=repositories" className="text-center border-b-2 border-transparent hover:border-purple-300 hover:text-purple-300 transition duration-300 font-bold py-2 px-4" target='_blank'>Ver mas repositorios</a>
